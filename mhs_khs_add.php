...
if (isset($_POST['submit'])) {
  ...
  $sks_kumulatif = mysqli_escape_string($conn, $_POST['sks_kumulatif']);
  $ip = mysqli_escape_string($conn, $_POST['ip']);
  $ipk = mysqli_escape_string($conn, $_POST['ipk']);
  $scan = $_POST['scan'];
  ...
  if ($submit) {
    ...
    $query = "INSERT INTO khs (nim, smt, sks, sks_kumulatif, ip, ipk, scan) VALUES ('$nim', '$smt', '$sks','$sks_kumulatif', '$ip', '$ipk', '$scan')";
