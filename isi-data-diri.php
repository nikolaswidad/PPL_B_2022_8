...
if (isset($_POST['submit'])) {
  ...
  if ($submit) {
    ...
    $query = "INSERT INTO mhs SET foto = '$foto', id_user = '$id_user', nama = '$nama', nim = '$nim', angkatan = '$angkatan',
     status_mhs = '$status_mhs', nip = '$nip', hp = '$hp', email = '$email', alamat = '$alamat', id_provinsi = '$provinsi', id_kabupaten = '$kabupaten'";
