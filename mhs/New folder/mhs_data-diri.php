...
if (isset($_POST['submit'])) {
  ...
  if ($submit) {
    ...
    $query = "INSERT INTO mhs (id_user, foto, nama, nim, angkatan, id_status_mhs, nip, hp, email, alamat, id_provinsi, id_kabupaten) VALUES ('$id_user' ,'$namefile', '$nama', '$nim', '$angkatan', '$status_mhs', '$nip', '$hp', '$email', '$alamat', $provinsi, $kabupaten)";
